...
namespace InfimaGames.LowPolyShooterPack
{
    ...
    public class Weapon : WeaponBehaviour
    {
        ...
        public override void Fire(float spreadMultiplier = 1.0f)
        {
            ...
            {
                hit.collider.gameObject.GetComponent<zombie>().ZombieKilled();
            }

            if (hit.collider.gameObject.GetComponent<zombidoktor>())
            {
                hit.collider.gameObject.GetComponent<zombidoktor>().ZombieKilled();
            }
